...
- [ ] 10.12 Deferred: S2 (sweep/finalize ownership boundary → S28 scope), S4 (`cli:build:lib` split — moot unless the test edge becomes a cost), non-null-assertion residue (→ SF7 typecheck-gate batch)
